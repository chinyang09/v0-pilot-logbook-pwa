...
import type { SyncQueueItem, SyncCollection, SyncOperationType, SyncMeta } from "@/types/sync/sync.types"
 ...
 */
export async function getSyncQueueByCollection(collection: SyncCollection): Promise<SyncQueueItem[]> {
 ...
 */
export async function clearSyncQueueByCollection(collection: SyncCollection): Promise<void> {
