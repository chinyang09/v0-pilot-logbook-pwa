...
export const LogbookCalendar = forwardRef<CalendarHandle, LogbookCalendarProps>(function LogbookCalendar(
  ...
  const handleTouchMove = (e: React.TouchEvent) => {
    ...
    if (diffY > 30 && !hasTriggeredSwipeStart && !isExternalScrollRef.current) {
          ...
          {calendarDays.map((dayInfo, dayIndex) => {
            ...
            return (
              <button
                ...
                disabled={!hasFlights}
                className={cn(
                  "flex items-center justify-center text-sm rounded-lg relative transition-all duration-200",
