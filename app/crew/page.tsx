...
import { Search, Loader2, User, Plus, ArrowLeft, Trash2, ChevronRight } from "lucide-react"
    ...
    <div className="relative overflow-hidden rounded-lg">
      ...
      <button
        ...
        className={cn(
          ...
          crew.isMe && "bg-gradient-to-r from-primary/10 to-primary/5 border-primary/20",
        )}
        ...
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              {crew.organization && <div className="text-sm text-muted-foreground truncate">{crew.organization}</div>}
...
export default function CrewPage() {
  ...
  const handleAddCrew = () => {
    const url = fieldType ? `/crew/new?field=${fieldType}&return=${encodeURIComponent(returnUrl)}` : "/crew/new"
    router.push(url)
  }
      ...
      <AlertDialog open={!!deleteTarget} onOpenChange={() => setDeleteTarget(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete {deleteTarget?.isMe ? "Self" : deleteTarget?.name}?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
